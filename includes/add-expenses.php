...
$navUser = $row['name'];
$activePage = 'expenses'; $pageTitle = 'Expenses'; $showSearch = false;
?>
<!DOCTYPE html><html lang="en"><head>
<meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<title>Add Expense — Expenditure</title>
...
<div class="page-wrap">
  <div class="page-header">
    <div>
      <p class="page-label">Track Spending</p>
  ...
  <div class="content-card">
    <p class="card-sub">Quickly log an expense and keep your spending organized.</p>
    <form id="expenseForm">
      <div class="form-grid-2">
        <div class="form-group">
          <label for="dateexpense">Date of Expense</label>
          <input class="form-control" type="date" id="dateexpense" name="dateexpense" value="<?= date('Y-m-d') ?>">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input class="form-control" type="number" id="costitem" name="costitem" required placeholder="0.00" step="0.01" min="0">
        </div>
        <div class="form-group">
          <label for="category-description">Description</label>
          <input class="form-control" type="text" id="category-description" name="category-description" placeholder="Optional notes">
        </div>
      </div>
      <div class="form-actions">
        <div id="success-message" class="alert alert-success" style="display:none;">Expense added successfully.</div>
    ...
    <form id="add-category-form">
      ...
      <div class="modal-body">
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="category-name" name="category-name" placeholder="e.g. Food, Transport..." required>
...
@media(max-width:640px){ .form-grid-2 { grid-template-columns: 1fr; } .page-header { flex-direction: column; } }
</style>
...
$(document).ready(function() {
  ...
  function loadCategories() {
    $.ajax({ url: 'api/get-categories.php', type: 'GET', data: { mode: 'expense' }, dataType: 'json',
      success: function(r) {
        if (r.status === 'success') {
  ...
  $('#expenseForm').on('submit', function(e) {
    e.preventDefault();
    $.ajax({ url: 'api/add-expense.php', type: 'POST', data: $(this).serialize(), dataType: 'json',
      success: function(r) {
