...
<head>
    ...
    <style>
        .container { background-color: #101b30; border-radius: 12px; box-shadow: 0px 20px 40px rgba(0,0,0,0.35); padding: 20px; margin-top: 20px; border: 1px solid rgba(255,255,255,0.08); }
        .table th, .table td { vertical-align: middle; color: #e8eef8; }
        .table th { background-color: #162244; border-color: rgba(255,255,255,0.08); font-weight: bold; text-transform: uppercase; color: #cfd9ed; }
        .table td { background-color: #121b30; border-color: rgba(255,255,255,0.08); }
        .loading-spinner { text-align: center; padding: 40px; color: #cfd9ed; }
        .summary-box { background: #131f36; padding: 15px; border-radius: 10px; margin-bottom: 15px; border: 1px solid rgba(255,255,255,0.08); }
        .summary-box h5 { margin: 0; color: #e8eef8; }
    </style>
</head>
<body>
<div class="sidebar">
