...
## Overview
This API allows for managing expenses, income, and categories. All endpoints are located in the `includes/api/` directory and return JSON responses.
...
- **Authentication**: Required (JWT or Session)
- **Parameters**:
    - `type` (string, optional): Data type - "all", "expense", or "income" (default: "all")
...
- **CSV Format**: 
    ...
    2024-01-15,"Monthly salary",0,5000,Salary
    2024-01-16,"Groceries",150,0,Food
    ```
...
- **CSV Format Expected**:
    ```
    Date,Particulars,Expense,Income,Category
    2024-01-15,"Description",expense_amount,income_amount,category_name
    ```
- **Response**:
    ```json
    {
